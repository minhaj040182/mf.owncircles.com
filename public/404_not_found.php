<?php
/**
 * Standalone 404 Not Found HTTP Handler for Unknown URLs that Never Existed
 * Emits raw HTTP 404 Not Found header and preserves the exact site design
 * Works with or without JavaScript enabled.
 */

// 1. Send genuine HTTP 404 Not Found headers
...
<head>
  ...
  <title>404 Page Not Found | TrendPulse</title>
...
<body className="min-h-screen flex flex-col bg-slate-50 text-slate-800 antialiased font-sans">
  <div class="min-h-screen flex flex-col bg-slate-50">
    ...
    <!-- Main Content Area: 404 Not Found Card -->
      ...
      <div id="not-found-page" class="w-full flex items-center justify-center py-6">
        <div class="max-w-xl w-full bg-white border border-gray-200 rounded-3xl p-8 sm:p-10 shadow-lg text-center space-y-6 animate-fadeIn">
          ...
          <div class="relative inline-block">
            <div class="w-20 h-20 rounded-3xl mx-auto flex items-center justify-center shadow-inner bg-blue-50 text-blue-600 border border-blue-100">
              <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" stroke-width="2"/>
                <polyline points="14 2 14 8 20 8" stroke-width="2"/>
                <circle cx="10" cy="13" r="2" stroke-width="2"/>
                <path d="m20 17-1.09-1.09a2 2 0 0 0-2.82 0L10 22" stroke-width="2"/>
              </svg>
            </div>
    ...
    <footer class="bg-slate-100 border-t border-gray-200 text-slate-600 py-10 px-4 mt-16 text-xs">
      <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="pt-6 border-t border-gray-200 text-center text-slate-400 text-[11px]">
          &copy; <?php echo date('Y'); ?> TrendPulse &bull; OwnCircles. All rights reserved.
        </div>
      </div>
    </footer>
  </div>
