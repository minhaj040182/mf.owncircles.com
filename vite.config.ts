...
export default defineConfig(() => {
  return {
    // Disable Vite's SPA history fallback. Every clean URL must resolve to its
    // own generated HTML document instead of silently returning Home.
    appType: 'mpa' as const,
    plugins: [react(), tailwindcss(), youtubeApiPlugin(), staticMpaPreviewPlugin()],
    base: '/',
    resolve: {
      alias: {
