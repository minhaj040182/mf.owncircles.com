...
export default function RightSidebarAd({ reloadKey }: RightSidebarAdProps) {
  ...
  return (
    <div 
      ...
      className="hidden xl:flex w-[180px] min-h-[600px] py-2 bg-slate-50 border-l border-slate-200/60 flex-col items-center justify-start select-none sticky top-20"
    >
      {/* Policy Compliant Ad Label */}
      <span className="text-[9px] font-mono uppercase tracking-widest text-slate-400 font-bold mb-1.5">
        — Advertisement —
      </span>
